...
public class DefaultCommitWorderTests
{
    ...
    public void OneUpdate_MakeCommitDetails_HasProjectDetails()
    {
        ...
        Assert.That(report,
            Does.Contain("Updated `folder\\src\\project1\\packages.config` to `foo.bar` `1.2.3` from `1.1.0`"));
    }
    ...
    public void TwoUpdates_MakeCommitDetails_HasProjectList()
    {
        ...
        Assert.That(report,
            Does.Contain("Updated `folder\\src\\project1\\packages.config` to `foo.bar` `1.2.3` from `1.1.0`"));
        Assert.That(report,
            Does.Contain("Updated `folder\\src\\project2\\packages.config` to `foo.bar` `1.2.3` from `1.0.0`"));
    }
    ...
    public void TwoUpdatesSameVersion_MakeCommitDetails_HasProjectList()
    {
        ...
        Assert.That(report,
            Does.Contain("Updated `folder\\src\\project1\\packages.config` to `foo.bar` `1.2.3` from `1.1.0`"));
        Assert.That(report,
            Does.Contain("Updated `folder\\src\\project3\\packages.config` to `foo.bar` `1.2.3` from `1.1.0`"));
    }
