...
<PackageReference Update=""bar"" Version=""2.3.4.5"" /></ItemGroup></Project>";
    ...
    public void ResultIsReiterable()
    {
        ...
        foreach (var package in packages) PackageAssert.IsPopulated(package);
    ...
    {
        var badVersion =
            PackagesFileWithTwoPackages.Replace("1.2.3.4", "notaversion", StringComparison.OrdinalIgnoreCase);
