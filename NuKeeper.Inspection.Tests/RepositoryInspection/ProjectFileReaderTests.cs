...
<Project>
    ...
    {
        var reader = MakeReader();
        var packages = reader.Read(StreamFromString(Vs2017ProjectFileTemplateWithoutPackages), _sampleDirectory,
            _sampleFile);
    ...
    {
        var projectFile =
            Vs2017ProjectFileTemplateWithPackages.Replace("{{Packages}}", "", StringComparison.OrdinalIgnoreCase);
    ...
    public void SinglePackageCanBeReadPackageReferences()
    {
        ...
        var projectFile =
            Vs2017ProjectFileTemplateWithPackages.Replace("{{Packages}}", packagesText,
    ...
    {
        var reader = MakeReader();
        var packages = reader.Read(StreamFromString(Vs2017ProjectFileFullFrameworkWithPackages), _sampleDirectory,
            _sampleFile);
    ...
    {
        var reader = MakeReader();
        var packages = reader.Read(StreamFromString(Vs2017ProjectFileTemplateWithPackages), _sampleDirectory,
            _sampleFile);

        foreach (var package in packages) Assert.That(package, Is.Not.Null);
    ...
    public void PackageReferenceWithoutVersionShouldBeSkipped()
    {
        ...
        var projectFile =
            Vs2017ProjectFileTemplateWithPackages.Replace("{{Packages}}", noVersion,
                StringComparison.OrdinalIgnoreCase);
