...
public class InspectCommandTests
{
        ...
        string outputFileName = null)
    {
        ...
        if (outputDestination.HasValue) command.OutputDestination = outputDestination.Value;
        if (outputFormat.HasValue) command.OutputFormat = outputFormat.Value;

        if (!string.IsNullOrWhiteSpace(outputFileName)) command.OutputFileName = outputFileName;
