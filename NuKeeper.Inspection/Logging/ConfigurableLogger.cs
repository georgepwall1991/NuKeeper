...
public class ConfigurableLogger : INuKeeperLogger, IConfigureLogger
{
    ...
    public void Error(string message, Exception ex)
    {
        ...
        if (ex?.InnerException != null) Error("Inner Exception", ex.InnerException);
    }
    ...
    {
        if (_inner == null) _inner = CreateLogger(LogLevel.Detailed, LogDestination.Console, string.Empty);
    }
