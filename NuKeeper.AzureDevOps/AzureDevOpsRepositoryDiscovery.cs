...
public class AzureDevOpsRepositoryDiscovery : IRepositoryDiscovery
{
    ...
    public AzureDevOpsRepositoryDiscovery(INuKeeperLogger logger, ICollaborationPlatform collaborationPlatform,
        string token)
    {
        _logger = logger;
    ...
    private RepositorySettings CreateRepositorySettings(string org, Uri repositoryUri, string project, string repoName,
