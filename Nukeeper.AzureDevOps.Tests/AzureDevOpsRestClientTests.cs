...
public class AzureDevOpsRestClientTests
{
    ...
    public void InitializesCorrectly()
    {
        ...
        Assert.IsTrue(
            httpClient.DefaultRequestHeaders.Accept.Contains(new MediaTypeWithQualityHeaderValue("application/json")));
        Assert.IsTrue(
            httpClient.DefaultRequestHeaders.Authorization.Equals(
    ...
    public void ThrowsWithBadJson()
    {
        var fakeHttpMessageHandler = new FakeHttpMessageHandler(new HttpResponseMessage
        {
            ...
            Content = new StringContent(JsonSerializer.Serialize("<body>Login Page</body>"), Encoding.UTF8,
        ...
        var restClient = new AzureDevOpsRestClient(httpClientFactory, Substitute.For<INuKeeperLogger>(), "PAT",
            fakeHttpClient.BaseAddress);
        var exception =
            Assert.ThrowsAsync<NuKeeperException>(async () => await restClient.GetGitRepositories("Project"));
    }
        ...
        var gitRefsResource = new GitRefsResource
        {
            ...
            value = new List<GitRefs>
            {
                new()
                {
                    ...
                    url =
                        "https://dev.azure.com/fabrikam/_apis/git/repositories/278d5cd2-584d-4b63-824a-2ba458937249/refs/heads/develop"
                },
                new()
                {
                    ...
                    url =
                        "https://dev.azure.com/fabrikam/_apis/git/repositories/278d5cd2-584d-4b63-824a-2ba458937249/refs/heads/master"
                },
                new()
                {
                    name = "refs/tags/v1.0",
                    objectId = "23d0bc5b128a10056dc68afece360d8a0fabb014",
                    url =
                        "https://dev.azure.com/fabrikam/_apis/git/repositories/278d5cd2-584d-4b63-824a-2ba458937249/refs/tags/v1.0"
                }
            }
        };
            ...
            value = new[]
            {
                new PullRequest
                {
                    AzureRepository = new AzureRepository
                    {
                        ...
                        name = "2016_10_31",
                        url =
                            "https://dev.azure.com/fabrikam/_apis/git/repositories/3411ebc1-d5aa-464f-9615-0b527bc66719",
                        project = new Project
                        {
                    ...
                    Url =
                        "https: //dev.azure.com/fabrikam/_apis/git/repositories/3411ebc1-d5aa-464f-9615-0b527bc66719/commits/b60280bc6e62e2f880f1b63c1e24987664d3bda3",
    ...
    [TestCase("proj/_apis/git/repositories/Id/pullrequests", false,
        "proj/_apis/git/repositories/Id/pullrequests?api-version=4.1")]
    [TestCase("proj/_apis/git/repositories/Id/pullrequests", true,
        "proj/_apis/git/repositories/Id/pullrequests?api-version=4.1-preview.1")]
    [TestCase("proj/_apis/git/repositories/Id/pullrequests?searchCriteria.sourceRefName=head", false,
        "proj/_apis/git/repositories/Id/pullrequests?searchCriteria.sourceRefName=head&api-version=4.1")]
    [TestCase("proj/_apis/git/repositories/Id/pullrequests?searchCriteria.sourceRefName=head", true,
        "proj/_apis/git/repositories/Id/pullrequests?searchCriteria.sourceRefName=head&api-version=4.1-preview.1")]
    ...
    private static AzureDevOpsRestClient GetFakeClient(object returnObject)
    {
        ...
        {
            StatusCode = HttpStatusCode.OK,
            Content = new StringContent(JsonSerializer.Serialize(returnObject, JsonOptions), Encoding.UTF8,
                new MediaTypeHeaderValue("application/json"))
        });
        ...
        var httpClientFactory = Substitute.For<IHttpClientFactory>();
        httpClientFactory.CreateClient().Returns(fakeHttpClient);
        return new AzureDevOpsRestClient(httpClientFactory, Substitute.For<INuKeeperLogger>(), "PAT",
            fakeHttpClient.BaseAddress);
    }
}
