...
public class PackageInProjectReader
{
        ...
        IEnumerable<string> projectReferences)
    {
        ...
        {
            _logger.Normal(
                $"Skipping package '{id}' with version '{version}' that could not be parsed in file '{path.FullName}'.");
            return null;
        }
        ...
        {
            _logger.Normal(
                $"Skipping package '{id}' with version range '{version}' that is not a single version in file '{path.FullName}'.");
            return null;
        }
