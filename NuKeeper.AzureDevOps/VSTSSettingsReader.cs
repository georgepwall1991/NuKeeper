...
public class VstsSettingsReader : BaseSettingsReader
{
    ...
    public override async Task<RepositorySettings> RepositorySettings(Uri repositoryUri, bool setAutoMerge,
    ...
    private static RepositorySettings CreateSettingsFromRemote(Uri repositoryUri)
    {
        ...
        {
            throw new NuKeeperException(
                "Unknown format. Format should be https://{org}.visualstudio.com/{project}/_git/{repo}");
        }
    ...
    private async Task<RepositorySettings> CreateSettingsFromLocal(Uri repositoryUri, string targetBranch)
    {
        ...
        {
            throw new NuKeeperException(
                "Unknown local format. Format should be https://{org}.visualstudio.com/_git/{repo}");
        }

        return RepositorySettings(org, project, repoName, remoteInfo);
    }

    private static RepositorySettings RepositorySettings(string org, string project, string repoName,
