...
public class AzureDevOpsRepositoryDiscoveryTests
{
    ...
    public async Task OrgModeInvalidReposAreExcluded()
    {
        var inputRepos = new List<Repository>
        {
            ...
            RepositoryBuilder.MakeRepository("http://b.com/repob.git".ToUri())
        };
    ...
    public async Task SuccessInGlobalMode()
    {
        ...
        var repos = await githubRepositoryDiscovery.GetRepositories(new SourceControlServerSettings
    ...
    private static IRepositoryDiscovery MakeAzureDevOpsRepositoryDiscovery(
